...
PROPERTY_DISPLAY_NAME = "Property 3 (A/B 동)"
...
# Firebase 설정
FIREBASE_CREDENTIALS_PATH = clean_path(r"C:\PMS\Property3\firebase-service-account.json")
FIREBASE_DATABASE_URL = "https://kiosk-pms-default-rtdb.asia-southeast1.firebasedatabase.app/"

# AutoHotkey 설정
AHK_SCRIPT_PATH = clean_path(r"C:\PMS\Property3\pms_automator.ahk")
AHK_EXE_PATH = clean_path(r"C:\Program Files\AutoHotkey\v1.1.37.02\AutoHotkeyU64.exe")
ROOM_NUMBER_FILE = clean_path(r"C:\PMS\Property3\room_number_data.tmp")

# 로그 파일
LOG_FILE = clean_path(r"C:\PMS\Property3\listener.log")
